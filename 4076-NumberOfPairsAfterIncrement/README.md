...
**Difficulty:** Hard  
[View on LeetCode](https://leetcode.com/problems/number-of-pairs-after-increment/)
...
- `queries[i] == [1, x, y, val], or` - `queries[i] == [2, tot]` - `0 <= x <= y < nums2.length` - `1 <= val <= 10^5` - `1 <= tot <= 10^9​​​​​​​`
