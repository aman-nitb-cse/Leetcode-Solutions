...
SequenceProductParity[1, 1, 3]1 * 1 * 3 = 3Odd[1, 2, 2]1 * 2 * 2 = 4Even[2, 1, 2]2 * 1 * 2 = 4Even[2, 2, 1]2 * 2 * 1 = 4Even[1, 3, 1]1 * 3 * 1 = 3Odd[3, 1, 1]3 * 1 * 1 = 3Odd
...
SequenceProductParity[1, 2]1 * 2 = 2Even[2, 1]2 * 1 = 2Even
